...
class TestVersionHistory:
    ...
    class TestInit:
        ...
        def test_models_added_to_history_in_correct_order(
            ...
            assert instance.history[0].version_message == version_history_dict[0]['version_message']
            assert instance.history[1].version_message == version_history_dict[1]['version_message']
        ...
        def test_model_with_no_previous_versions_only_returns_one_entry_and_does_not_enter_loop(
            ...
            # ASSERT
            assert all(
                len(version_property) == 1 for version_property in [
                    instance.dictionary,
                    instance.history,
                ]
            )
